...
@section('title', 'Usuarios - EventUP')
...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            <!-- DataGrid -->
            <table id="dg-users" class="easyui-datagrid" style="width:100%;height:700px" data-options="
    ...
    <div id="dlg-user" class="easyui-dialog" style="width:500px;padding:20px" closed="true" buttons="#dlg-buttons">
        <form id="fm-user" method="post">
            ...
            <div class="mb-3">
                ...
                <input class="easyui-textbox" name="email" id="user-email" style="width:100%"
            ...
            <div class="mb-3">
                ...
                <small class="text-muted" id="password-help" style="display:none">Dejar vacio para mantener la contrasena
                    actual</small>
            </div>
            <div class="mb-3">
                <label class="form-label">Roles</label>
                <select class="easyui-combobox" name="roles[]" id="user-roles" style="width:100%" data-options="
    ...
    <div id="dlg-buttons">
        ...
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel"
            onclick="$('#dlg-user').dialog('close')" style="width:90px">Cancelar</a>
    </div>
@endsection
