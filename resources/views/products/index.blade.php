...
@section('title', 'Productos - EventUP')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div id="toolbar" style="padding:5px;">
                <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" plain="true"
                    onclick="newProduct()">Nuevo Producto</a>
                <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-edit" plain="true"
                    onclick="editProduct()">Editar</a>
                <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-remove" plain="true"
                    onclick="deleteProduct()">Eliminar</a>
                <span class="ms-3">
            ...
            <!-- DataGrid -->
            <table id="dg-products" class="easyui-datagrid" style="width:100%;height:700px" data-options="
            ...
            <form id="fm-product" method="post">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input class="easyui-textbox" name="code" id="product-code" style="width:100%"
                            data-options="required:true">
                    </div>
                    <div class="col-md-8 mb-3">
                        <label class="form-label">Nombre <span class="text-danger">*</span></label>
                        <input class="easyui-textbox" name="name" id="product-name" style="width:100%"
                            data-options="required:true">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input class="easyui-textbox" name="unit" id="product-unit" style="width:100%" value="UND"
                            data-options="required:true">
                    </div>
                    <div class="col-md-3 mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input class="easyui-textbox" name="description" id="product-description" style="width:100%"
        ...
        <div id="dlg-buttons">
            ...
            <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel"
                onclick="$('#dlg-product').dialog('close')" style="width:90px">Cancelar</a>
        </div>
@endsection
