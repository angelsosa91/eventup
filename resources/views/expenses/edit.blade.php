                ...
                <div class="row mb-3">
                    <div class="col-md-3">
                        ...
                        <input type="number" class="form-control" id="amount" name="amount" step="0.01" min="0.01" required
                            value="{{ $expense->amount }}" onchange="calculateTax()">
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-select" id="payment_method" name="payment_method">
                            ...
                            <option value="transfer" {{ $expense->payment_method == 'transfer' ? 'selected' : '' }}>
                                Transferencia</option>
                            <option value="card" {{ $expense->payment_method == 'card' ? 'selected' : '' }}>Tarjeta
                            </option>
                        </select>
                    </div>
                </div>
