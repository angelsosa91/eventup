        ...
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div>
                <button type="button" class="btn btn-secondary"
                    onclick="window.location.href='{{ route('account-payables.index') }}'">
                    ...
                    <table class="table table-sm">
                        ...
                        @if($payable->purchase_number)
                            <tr>
                                ...
                                <td>
                                    <a
                                        href="{{ route('purchases.show', $payable->purchase_id) }}">{{ $payable->purchase_number }}</a>
                                </td>
                            </tr>
                        @endif
                        <tr>
                ...
                <div class="col-md-6">
                    ...
                    <table class="table table-sm">
                        ...
                        <tr class="table-active">
                            ...
                            <td class="text-end"><strong>{{ number_format($payable->balance, 0, ',', '.') }} Gs.</strong>
                            </td>
                        </tr>
                        <tr>
