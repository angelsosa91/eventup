                ...
                <div class="col-md-6">
                    ...
                    <table class="table table-sm">
                        ...
                        <tr class="table-primary">
                            ...
                            <td class="text-end"><strong>{{ number_format($register->expected_balance, 0, ',', '.') }}
                                    Gs.</strong></td>
                        </tr>
                        @if($register->status === 'closed')
                            <tr class="table-info">
                                <td><strong>Saldo Real:</strong></td>
                                <td class="text-end"><strong>{{ number_format($register->actual_balance, 0, ',', '.') }}
                                        Gs.</strong></td>
                            </tr>
                            <tr
                                class="{{ $register->difference == 0 ? 'table-success' : ($register->difference > 0 ? 'table-warning' : 'table-danger') }}">
