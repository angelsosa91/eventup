...
@section('content')
        ...
        <div class="card-header d-flex justify-content-between align-items-center bg-success text-white">
            ...
            <div>
                <button type="button" class="btn btn-light btn-sm"
                    onclick="window.location.href='{{ route('cash-registers.index') }}'">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-3">
                    <div class="card bg-danger text-white">
                        <div class="card-body text-center">
                            <small>Egresos</small>
                            <h4 class="mb-0">{{ number_format($register->payments + $register->expenses, 0, ',', '.') }}
                            </h4>
                            <small>Gs.</small>
                        </div>
                    </div>
            ...
            <table class="table table-bordered table-hover table-sm">
                <thead class="table-light">
                    <tr>
                        ...
                        <th>Tipo</th>
                        <th>Concepto</th>
                        les_cash + $register->collections, 0, ',', '.') }}</h4>
                        <small>Gs.</small>
                        <th>Descripción</th>
                        <th>Referencia</th>
    ...
    <!-- Movement Dialog -->
    <div id="movementDlg" class="easyui-dialog" style="width:500px;padding:20px;" closed="true"
        buttons="#movementDlg-buttons">
    ...
    <div id="movementDlg-buttons">
        ...
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel"
            onclick="$('#movementDlg').dialog('close')">Cancelar</a>
    </div>
    ...
    <div id="closeDlg-buttons">
        ...
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel"
            onclick="$('#closeDlg').dialog('close')">Cancelar</a>
    </div>
