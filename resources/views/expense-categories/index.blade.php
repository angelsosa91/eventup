...
@section('title', 'Categorías de Gastos - EventUP')
...
@section('content')
        ...
        <div class="card-body">
            ...
            <div id="toolbar" style="padding:5px;">
                <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" plain="true"
                    onclick="newCategory()">Nueva Categoría</a>
                <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-edit" plain="true"
                    onclick="editCategory()">Editar</a>
                <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-remove" plain="true"
                    onclick="deleteCategory()">Eliminar</a>
                <span class="ms-3">
            ...
            <!-- DataGrid -->
            <table id="dg-categories" class="easyui-datagrid" style="width:100%;height:500px" data-options="
    ...
    <div id="dlg-category" class="easyui-dialog" style="width:500px;padding:20px" closed="true" buttons="#dlg-buttons">
        <form id="fm-category" method="post">
            ...
            <div class="mb-3">
                ...
                <input class="easyui-textbox" name="name" id="category-name" style="width:100%"
                    data-options="required:true">
            </div>

            <div class="mb-3">
                <label class="form-label">Descripción</label>
                <input class="easyui-textbox" name="description" id="category-description" style="width:100%"
                    data-options="multiline:true,height:80">
            </div>

            <div class="mb-3">
                <label class="form-label">Cuenta Contable del Plan de Cuentas <span class="text-danger">*</span></label>
                <select class="easyui-combobox" name="account_id" id="category-account" style="width:100%" data-options="
    ...
    <div id="dlg-buttons">
        ...
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel"
            onclick="$('#dlg-category').dialog('close')" style="width:90px">Cancelar</a>
    </div>
@endsection
