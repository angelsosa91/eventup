...
@section('content')
            ...
            <div id="toolbar" style="padding:5px;">
                @can('roles.create')
                    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" plain="true"
                        onclick="newRole()">Nuevo Rol</a>
                @endcan
                @can('roles.edit')
                    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-edit" plain="true"
                        onclick="editRole()">Editar</a>
                @endcan
                @can('roles.delete')
                    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-remove" plain="true"
                        onclick="deleteRole()">Eliminar</a>
                @endcan
            </div>

            <!-- DataGrid -->
            <table id="dg-roles" class="easyui-datagrid" style="width:100%;height:700px" data-options="
        ...
        <form id="fm-role" method="post">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input class="easyui-textbox" name="name" id="role-name" style="width:100%"
                        data-options="required:true">
                </div>
                <div class="col-md-6 mb-3">
                    <label class="form-label">Slug <span class="text-danger">*</span></label>
                    <input class="easyui-textbox" name="slug" id="role-slug" style="width:100%"
                        data-options="required:true">
                </div>
            </div>
            <div class="mb-3">
                <label class="form-label">Descripcion</label>
                <input class="easyui-textbox" name="description" id="role-description" style="width:100%"
    ...
    <div id="dlg-buttons">
        ...
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel"
            onclick="$('#dlg-role').dialog('close')" style="width:90px">Cancelar</a>
    </div>
@endsection
