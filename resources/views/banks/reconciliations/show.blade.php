                ...
                <div class="col-md-6">
                    ...
                    <table class="table table-sm">
                        ...
                        <tr>
                            ...
                            <td>{{ $reconciliation->bankAccount->account_name }}
                                ({{ $reconciliation->bankAccount->account_number }})</td>
                        </tr>
                        <tr>
                            <th>Banco:</th>
                        ...
                        <tr>
                            <th>Período:</th>
                            <td>{{ \Carbon\Carbon::parse($reconciliation->statement_start_date)->format('d/m/Y') }} al
                                {{ \Carbon\Carbon::parse($reconciliation->statement_end_date)->format('d/m/Y') }}</td>
                        </tr>
                ...
                <div class="col-md-6">
                    ...
                    <table class="table table-sm">
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <strong>{{ number_format($reconciliation->closing_balance, 0, ',', '.') }}</strong></td>
                        </tr>
                        <tr>
                            <th>Saldo en Sistema:</th>
                            <td class="text-end">
                                <strong>{{ number_format($reconciliation->system_balance, 0, ',', '.') }}</strong></td>
                        </tr>
                        <tr
                            class="@if(abs($reconciliation->difference) < 1) table-success @elseif(abs($reconciliation->difference) < 10000) table-warning @else table-danger @endif">
                            <th>Diferencia:</th>
                            <td class="text-end">
                                <strong>
            ...
            <table class="table table-striped table-hover">
                ...
                <tfoot>
                    ...
                    <tr class="table-light">
                        ...
                        <th class="text-end">
                            <strong>{{ number_format($totalDeposits - $totalWithdrawals, 0, ',', '.') }}</strong></th>
                        <th></th>
                    </tr>
                </tfoot>
            </table>
