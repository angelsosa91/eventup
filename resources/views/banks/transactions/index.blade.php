...
@section('content')
    <div id="toolbar" style="padding: 10px;">
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" onclick="newTransaction()">Nueva
            Transacción</a>
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-redo" onclick="transfer()">Transferencia</a>
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-save" onclick="cashDeposit()">Depósito desde
            Caja</a>
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-back" onclick="cashWithdrawal()">Retiro a
            Caja</a>
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel"
            onclick="cancelTransaction()">Anular</a>
    ...
    <!-- Transaction Dialog -->
    <div id="transactionDlg" class="easyui-dialog" style="width:600px;padding:20px;" closed="true"
        buttons="#transactionDlg-buttons">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <select class="form-select" id="bank_account_id" required>
                        ...
                        @foreach($accounts as $account)
                            <option value="{{ $account->id }}">{{ $account->bank_name }} - {{ $account->account_number }}
                            </option>
                        @endforeach
                    </select>
                </div>
    ...
    <div id="transactionDlg-buttons">
        ...
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel"
            onclick="$('#transactionDlg').dialog('close')">Cancelar</a>
    </div>

    <!-- Transfer Dialog -->
    <div id="transferDlg" class="easyui-dialog" style="width:600px;padding:20px;" closed="true"
        buttons="#transferDlg-buttons">
    ...
    <div id="transferDlg-buttons">
        ...
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel"
            onclick="$('#transferDlg').dialog('close')">Cancelar</a>
    </div>

    <!-- Cash Deposit Dialog -->
    <div id="cashDepositDlg" class="easyui-dialog" style="width:600px;padding:20px;" closed="true"
        buttons="#cashDepositDlg-buttons">
        ...
        <form id="cashDepositForm">
            ...
            <div class="mb-3">
                <label class="form-label">Concepto <span class="text-danger">*</span></label>
                <input type="text" class="form-control" id="deposit_concept" maxlength="255" value="Depósito desde caja"
                    required>
            </div>
            <div class="mb-3">
                <label class="form-label">Referencia</label>
    ...
    <div id="cashDepositDlg-buttons">
        ...
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel"
            onclick="$('#cashDepositDlg').dialog('close')">Cancelar</a>
    </div>

    <!-- Cash Withdrawal Dialog -->
    <div id="cashWithdrawalDlg" class="easyui-dialog" style="width:600px;padding:20px;" closed="true"
        buttons="#cashWithdrawalDlg-buttons">
        ...
        <form id="cashWithdrawalForm">
            ...
            <div class="mb-3">
                <label class="form-label">Concepto <span class="text-danger">*</span></label>
                <input type="text" class="form-control" id="withdrawal_concept" maxlength="255" value="Retiro a caja"
                    required>
            </div>
            <div class="mb-3">
                <label class="form-label">Referencia</label>
    ...
    <div id="cashWithdrawalDlg-buttons">
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-ok"
            onclick="submitCashWithdrawal()">Retirar</a>
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel"
            onclick="$('#cashWithdrawalDlg').dialog('close')">Cancelar</a>
    </div>
