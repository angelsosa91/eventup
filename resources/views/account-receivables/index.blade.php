...
@section('content')
    <div id="toolbar" style="padding: 10px;">
        ...
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-remove"
            onclick="deleteReceivable()">Eliminar</a>
        ...
        <span style="float: right;">
            <a href="{{ route('account-receivables.by-customer') }}" class="easyui-linkbutton" iconCls="icon-search">Ver por
                Cliente</a>
        </span>
    </div>
    ...
    <!-- Payment Dialog -->
    <div id="paymentDlg" class="easyui-dialog" style="width:500px;padding:20px;" closed="true"
        buttons="#paymentDlg-buttons">
    ...
    <div id="paymentDlg-buttons">
        ...
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel"
            onclick="$('#paymentDlg').dialog('close')">Cancelar</a>
    </div>
