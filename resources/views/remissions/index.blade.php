...
@section('content')
    <div id="toolbar" style="padding: 10px;">
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" onclick="newRemission()">Nueva
            Remisión</a>
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-search" onclick="viewRemission()">Ver
            Detalle</a>
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-ok" onclick="confirmRemission()">Confirmar</a>
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-truck" onclick="deliverRemission()">Marcar
            Entregada</a>
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-large-smartart"
            onclick="convertToSale()">Convertir a Factura</a>
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel" onclick="cancelRemission()">Anular</a>
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-print" onclick="printRemission()">Imprimir
            PDF</a>
    ...
    <table id="dg" class="easyui-datagrid" style="width:100%;height:700px;" data-options="
    ...
    <div id="dlg-convert-buttons">
        ...
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel"
            onclick="$('#dlg-convert').dialog('close')">Cancelar</a>
    </div>
