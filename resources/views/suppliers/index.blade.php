...
@section('title', 'Proveedores - EventUP')
...
@section('content')
        ...
        <div class="card-body">
            ...
            <div id="toolbar" style="padding:5px;">
                <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" plain="true"
                    onclick="newSupplier()">Nuevo Proveedor</a>
                <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-edit" plain="true"
                    onclick="editSupplier()">Editar</a>
                <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-remove" plain="true"
                    onclick="deleteSupplier()">Eliminar</a>
                <span class="ms-3">
            ...
            <!-- DataGrid -->
            <table id="dg-suppliers" class="easyui-datagrid" style="width:100%;height:700px" data-options="
        ...
        <form id="fm-supplier" method="post">
            ...
            <div class="row">
                <div class="col-md-8 mb-3">
                    ...
                    <input class="easyui-textbox" name="name" id="supplier-name" style="width:100%"
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input class="easyui-textbox" name="email" id="supplier-email" style="width:100%"
            ...
            <div class="mb-3">
                ...
                <input class="easyui-textbox" name="address" id="supplier-address" style="width:100%"
            ...
            <div class="mb-3">
                ...
                <input class="easyui-textbox" name="notes" id="supplier-notes" style="width:100%"
                    data-options="multiline:true,height:60">
            </div>
    ...
    <div id="dlg-buttons">
        <a href="javascript:void(0)" class="easyui-linkbutton c6" iconCls="icon-ok" onclick="saveSupplier()"
            style="width:90px">Guardar</a>
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel"
            onclick="$('#dlg-supplier').dialog('close')" style="width:90px">Cancelar</a>
    </div>
@endsection
